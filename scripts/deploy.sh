#!/usr/bin/env bash
#
# Deploy dorpshuis naar TransIP shared hosting.
#
# Vereist:
#   - SSH-sleutel ~/.ssh/id_ed25519_dorpshuis_deploy
...
readonly SSH_KEY="$HOME/.ssh/id_ed25519_dorpshuis_deploy"
readonly REMOTE_PATH='/data/sites/web/dvborgercompagnienl/subsites/dorpshuisborgercompagnie.nl'
